...
restaurantRouter.get("/:restaurantId/orders", authMiddleware, getRestaurantOrdersController);
restaurantRouter.patch("/orders/:id/status", authMiddleware, updateOrderStatusController);
