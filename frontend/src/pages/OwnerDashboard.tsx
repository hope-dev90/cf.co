...
const OwnerDashboard: React.FC = () => {
  ...
  const [categories, setCategories] = useState(['All', 'Appetizers', 'Main Course', 'Desserts', 'Drinks']);
  ...
  const [orders, setOrders] = useState<Order[]>([
    {
      ...
      items: [
        { menuItemId: '1', name: 'Grilled Atlantic Salmon', quantity: 1, price: 28.99 },
        { menuItemId: '5', name: 'Espresso Martini', quantity: 2, price: 11.99 },
      ],
      totalAmount: 52.97,
      status: 'pending',
    ...
    },
    {
      ...
      items: [
        ...
        { menuItemId: '4', name: 'Chocolate Lava Cake', quantity: 2, price: 8.99 },
      ],
      totalAmount: 67.96,
      status: 'confirmed',
      notes: '',
  ...
  const [orderFilterStatus, setOrderFilterStatus] = useState<'all' | 'pending' | 'confirmed' | 'preparing' | 'ready' | 'delivered' | 'cancelled'>('all');
  const [expandedOrderId, setExpandedOrderId] = useState<string | null>(null);

  // Analytics state
  const [analyticsDateRange, setAnalyticsDateRange] = useState<'today' | 'week' | 'month' | 'all'>('today');
  ...
  const [topSellingItems, setTopSellingItems] = useState([
    ...
    { name: 'Truffle Risotto', quantity: 10, revenue: 249.90 },
  ...
  const [customerInsights, setCustomerInsights] = useState({
    ...
    averageOrderValueByType: { new: 95.50, returning: 107.30 },
  });
  ...
  const [deliveryForm, setDeliveryForm] = useState<DeliverySettings>(deliverySettings);
  ...
  const handleAddMenuItem = () => {
    if (newMenuItemForm.name && newMenuItemForm.price && newMenuItemForm.prepTime) {
  ...
  const handleUpdateOperatingHours = (index: number, field: string, value: string | boolean) => {
        ...
        <div className="p-4 md:p-8">
          ...
          {activeTab === 'dashboard' && (
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600">Here's your restaurant performance today</p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <h2 className="text-xl font-bold text-[#1a1a2e] mb-4">Recent Orders</h2>
                    ...
                    <tbody>
                      {orders.slice(0, 5).map((order) => (
                        <tr key={order.id} className="border-b border-gray-100 hover:bg-gray-50">
                          <td className="py-3 px-4 font-mono text-gray-600">{order.orderNumber}</td>
          ...
          {activeTab === 'menu' && (
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-[#1a1a2e] mb-2">Menu Management</h1>
              ...
              {showAddMenuItem && (
                <div className="bg-white rounded-lg p-6 border-2 border-[#e8722a] space-y-4">
                  <h3 className="text-lg font-bold text-[#1a1a2e]">Add New Menu Item</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                      ...
                      onChange={(e) =>
                        setNewMenuItemForm({ ...newMenuItemForm, name: e.target.value })
                      }
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNewMenuItemForm({ ...newMenuItemForm, category: e.target.value })
                      }
                      className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#e8722a]"
                    >
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewMenuItemForm({ ...newMenuItemForm, price: e.target.value })
                      }
                      className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#e8722a]"
                    />
                    <input
                      ...
                      onChange={(e) =>
                        setNewMenuItemForm({ ...newMenuItemForm, prepTime: e.target.value })
                      }
                      className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#e8722a]"
                    />
                  </div>
                  <textarea
                    ...
                    onChange={(e) =>
                      setNewMenuItemForm({ ...newMenuItemForm, description: e.target.value })
                    }
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewMenuItemForm({ ...newMenuItemForm, imageUrl: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#e8722a]"
                  />
              ...
              {filteredMenuItems.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="p-4 space-y-3">
                        ...
                        <div className="flex gap-2 pt-2 border-t border-gray-200">
                          ...
                          >
                            {item.available ? <EyeOff className="w-3 h-3 inline mr-1" /> : <Eye className="w-3 h-3 inline mr-1" />}
                ...
                <div className="flex flex-col items-center justify-center py-16 bg-white rounded-lg border border-gray-200">
                  ...
                  <p className="text-gray-600 mb-6">Add your first dish to get started!</p>
                  <button
                    onClick={() => setShowAddMenuItem(true)}
          ...
          {activeTab === 'orders' && (
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-[#1a1a2e] mb-2">Orders Management</h1>
              ...
              {filteredOrders.length > 0 ? (
                    ...
                    >
                      ...
                      {expandedOrderId === order.id && (
                        <div className="border-t border-gray-200 p-4 space-y-4 bg-gray-50">
                          {/* Order Items */}
                          <div>
                            <h4 className="font-bold text-[#1a1a2e] mb-2">Items</h4>
                          ...
                          {/* Customer Info */}
                          <div className="space-y-2">
                            <h4 className="font-bold text-[#1a1a2e]">Customer Details</h4>
                ...
                <div className="flex flex-col items-center justify-center py-16 bg-white rounded-lg border border-gray-200">
                  ...
                  <h3 className="text-xl font-bold text-[#1a1a2e] mb-1">No orders</h3>
          ...
          {activeTab === 'analytics' && (
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-[#1a1a2e] mb-2">Analytics & Insights</h1>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-[#1a1a2e]">{totalOrdersCount}</p>
                    </div>
              ...
              {/* Top Selling Items */}
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                <h3 className="text-lg font-bold text-[#1a1a2e] mb-4">Top Selling Items</h3>
                  ...
                  {topSellingItems.map((item, idx) => (
                    <div key={idx} className="flex items-center justify-between pb-3 border-b border-gray-100 last:border-0">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-600">Quantity sold: {item.quantity}</p>
                      </div>
                      <div className="text-right">
                        <p className="font-bold text-[#e8722a]">${item.revenue.toFixed(2)}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {/* Orders by Status */}
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                <h3 className="text-lg font-bold text-[#1a1a2e] mb-4">Orders by Status</h3>
                <div className="space-y-3">
                  {[
                    { status: 'Pending', count: ordersByStatus.pending, color: 'bg-yellow-500' },
                    { status: 'Confirmed', count: ordersByStatus.confirmed, color: 'bg-blue-500' },
                    { status: 'Preparing', count: ordersByStatus.preparing, color: 'bg-purple-500' },
                    { status: 'Ready', count: ordersByStatus.ready, color: 'bg-green-500' },
                    { status: 'Delivered', count: ordersByStatus.delivered, color: 'bg-emerald-500' },
                    ...
                    return (
                      <div key={item.status}>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm font-bold text-[#1a1a2e]">{item.count}</span>
                        </div>
              ...
              {/* Peak Hours */}
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                <h3 className="text-lg font-bold text-[#1a1a2e] mb-4">Peak Orders by Time</h3>
                <div className="space-y-4">
                  {[
                    { time: 'Morning (6am-12pm)', orders: peakHours.morning, color: 'bg-yellow-400' },
                    { time: 'Afternoon (12pm-5pm)', orders: peakHours.afternoon, color: 'bg-orange-400' },
                    { time: 'Evening (5pm-10pm)', orders: peakHours.evening, color: 'bg-red-400' },
                    { time: 'Night (10pm-6am)', orders: peakHours.night, color: 'bg-indigo-400' },
                  ].map((slot) => {
              ...
              {/* Customer Insights */}
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                <h3 className="text-lg font-bold text-[#1a1a2e] mb-4">Customer Insights</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                    ...
                    <div className="text-blue-500 text-3xl font-bold">
                      {((customerInsights.newCustomers / (customerInsights.newCustomers + customerInsights.returningCustomers)) * 100).toFixed(0)}%
                    </div>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                    ...
                    <div className="text-green-500 text-3xl font-bold">
                      {((customerInsights.returningCustomers / (customerInsights.newCustomers + customerInsights.returningCustomers)) * 100).toFixed(0)}%
                    </div>
                  </div>
                </div>
                <div className="mt-6 pt-6 border-t border-gray-200 space-y-2">
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Avg Order Value (New)</span>
                    <span className="font-bold text-[#e8722a]">
                      ${customerInsights.averageOrderValueByType.new.toFixed(2)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Avg Order Value (Returning)</span>
                    <span className="font-bold text-[#e8722a]">
                      ${customerInsights.averageOrderValueByType.returning.toFixed(2)}
                    </span>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'settings' && (
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl font-bold text-[#1a1a2e] mb-2">Settings</h1>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200 space-y-4">
                <h2 className="text-2xl font-bold text-[#1a1a2e]">Restaurant Information</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setSettingsForm({ ...settingsForm, cuisineType: e.target.value })
                        }
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#e8722a]"
                      />
                    </div>
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <input
                      ...
                      onChange={(e) =>
                        setSettingsForm({ ...settingsForm, active: e.target.checked })
                      }
                      className="w-4 h-4"
                    />
                    <label className="text-sm font-semibold text-[#1a1a2e]">
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                <h2 className="text-2xl font-bold text-[#1a1a2e] mb-4">Operating Hours</h2>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                        ...
                        <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <input
                              ...
                              value={hour.openTime}
                              onChange={(e) =>
                                handleUpdateOperatingHours(idx, 'openTime', e.target.value)
                              }
                          ...
                          <td className="py-3 px-4">
                            <input
                              ...
                              onChange={(e) =>
                                handleUpdateOperatingHours(idx, 'closeTime', e.target.value)
                              }
                              className="px-2 py-1 border border-gray-300 rounded focus:outline-none focus:border-[#e8722a]"
                            />
                          </td>
                          <td className="py-3 px-4">
                            <input
                              ...
                              checked={hour.isOpen}
                              onChange={(e) =>
                                handleUpdateOperatingHours(idx, 'isOpen', e.target.checked)
                              }
                              className="w-4 h-4"
                            />
                          </td>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200 space-y-4">
                <h2 className="text-2xl font-bold text-[#1a1a2e]">Delivery Settings</h2>
